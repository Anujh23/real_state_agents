"""
Streamlit application for the Property Estate Chatbot.
...
st.set_page_config(
    page_title="Property Estate Consultant",
    layout="wide"
)
...
<style>
    ...
    :root {
        /* Primary Colors */
        --primary-dark: #0B1120;     /* deeper, richer navy */
        --primary-main: #1E293B;     /* elegant base */
        --primary-light: #475569;    /* soft contrast */
        --primary-accent: #0EA5E9;   /* bright teal-blue for CTAs */

        /* Secondary Colors */
        --secondary-warm: #F59E0B;   /* amber */
        --secondary-slate: #64748B;  /* neutral slate */
        --secondary-slate-light: #94A3B8; /* cool light text */

        /* State Colors */
        --success: #22C55E;          /* vibrant green */
        --warning: #FACC15;          /* sunny warning */
        --error: #EF4444;            /* strong error red */
        --info: #3B82F6;             /* modern blue info */

        /* Text Colors */
        --text-primary: #F8FAFC;     /* almost white */
        --text-secondary: #E2E8F0;   /* subtle gray-white */
        --text-tertiary: #94A3B8;    /* soft slate */
...
st.markdown('<div class="main-header"><h1>Property Estate Consultant</h1><p>Your virtual property estate consultant</p></div>', unsafe_allow_html=True)
...
with st.sidebar:
    ...
    if uploaded_file is not None:
        ...
        if st.session_state.image_processed:
            st.markdown('<div style="color: white; margin-bottom: 10px;">✓ Image processed</div>', unsafe_allow_html=True)
        else:
            st.markdown('<div style="color: red; margin-bottom: 10px;">⚠ Click "Process New Image" to analyze this image</div>', unsafe_allow_html=True)
